...
```typescript
import { calculateTargetHorizon, getTargetProbFromMargin } from '@fin-plan/smart-withdrawals-engine/life-expectancy';

const horizon = calculateTargetHorizon(
    [{ age: 65, gender: 'male' }],
    0.10 // Target probability of outliving the money (e.g. 10%)
);
```
